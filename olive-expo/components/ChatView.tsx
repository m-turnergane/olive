...
const ChatView: React.FC<ChatViewProps> = ({ user }) => {
    ...
    return (
      ...
      >
        <View style={[styles.messageBubble, isUser ? styles.userBubble : styles.modelBubble]}>
          {lines.map((line, i) => (
            <Text key={i} style={[styles.messageText, isUser && styles.userMessageText]}>
              {line}
            </Text>
          ))}
        </View>
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.subtitleText}>We're here to listen. What's on your mind?</Text>
    </View>
  );
  ...
  return (
    ...
    >
      <FlatList
        ...
        ListFooterComponent={
          isLoading ? (
            <View style={[styles.messageContainer, styles.modelMessageContainer]}>
